...
path <- "F:/Proccessing/Data/raw_data/meteo_all.csv"
...
list_station_tab <- read.xlsx("F:/Proccessing/Data/raw_data/meteostations_list.xlsx")
...
write.xlsx(output_days_hot, "F:/Proccessing/Results/output_days_hot_95per.xlsx")
write.xlsx(output_days_cold, "F:/Proccessing/Results/output_days_cold_95per.xlsx")
write.xlsx(output_waves_hot, "F:/Proccessing/Results/output_waves_hot_95per.xlsx")
write.xlsx(output_waves_cold, "F:/Proccessing/Results/output_waves_cold_95per.xlsx")
