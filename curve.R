...
spline_simple_table$region <- str_replace_all(spline_simple_table$region, c("Кемеровская область — Кузбасс" = "Кемеровская область",
                                                                            "Еврейская автономная область" = "Еврейская авт. область"))
...
tab_rr_all$reg <- str_replace_all(tab_rr_all$reg, c("Кемеровская область — Кузбасс" = "Кемеровская область",
                                                    "Еврейская автономная область" = "Еврейская авт. область"))
...
tab_rr_osnov$reg <- str_replace_all(tab_rr_osnov$reg, c("Кемеровская область — Кузбасс" = "Кемеровская область",
                                                        "Еврейская автономная область" = "Еврейская авт. область"))
...
tab_line$reg <- str_replace_all(tab_line$reg, c("Кемеровская область — Кузбасс" = "Кемеровская область",
                                                "Еврейская автономная область" = "Еврейская авт. область"))
